# Contributing to GCM MCP Server
...
docker build -t gcm-mcp-test -f container/Dockerfile .

# Test container
docker run -p 8002:8002 -e GCM_HOST="..." gcm-mcp-test
```
...
1. Go to https://github.com/IBM/gcm-mcp-server/pulls
...
- Open an issue: https://github.com/IBM/gcm-mcp-server/issues
